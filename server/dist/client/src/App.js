    ...
    return (<section className="flex flex-col justify-center items-center text-[#e4edfc] mt-[10vh]">
      {formVisiblility && (<form onSubmit={(e) => {
          ...
          <div className="flex flex-col text-sm">
            ...
            <textarea className={inputStyles} onChange={handleFormInputs} value={(_a = formData.description) !== null && _a !== void 0 ? _a : ""} placeholder="Description" rows={4} name="description"></textarea>
          </div>
        ...
        <section className="overflow-x-auto">
          <table className="mt-5 text-center">
            ...
            return (<tr className="border-b border-stone-700" key={task.id}>
                    ...
                    <td>
                      <p className={`p-1 rounded-md whitespace-nowrap ${task.status === "Complete"
